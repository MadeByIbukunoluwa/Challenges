...
// there is a console.log(print command) in the body, if we run the function, we dont need to use the console.log to print again but if we do, we are going to get an undefined value because it is similar to typing console.log(console.log()) so in this instance, if we want to use the return statement we will put both reduce expressions in the return statement or we can just create the variables withut adding console.log to them 
